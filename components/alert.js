...
const Alert = ({ preview }) =>
  preview && (
    <div className='bg-blue-200 dark:bg-blue-50 p-4'>
      <div className='flex'>
        ...
        <div className='ml-3 flex-1 sm:flex sm:justify-between'>
          ...
          <p className='mt-3 text-sm sm:mt-0 sm:ml-6 transform -translate-x-2 sm:translate-x-0'>
            <Link href='/api/exit-preview'>
              <a className='group whitespace-nowrap font-semibold text-blue-700 hover:text-blue-600 hover:font-bold'>
